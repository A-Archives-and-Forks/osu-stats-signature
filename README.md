...
The project is deployed on Vercel. Visit [osu-stats-signature.vercel.app](https://osu-stats-signature.vercel.app) to generate.
...
- [x] Fetch and display avatar and user cover
- [x] Cover blur support
- [x] Intro animation
- [x] Display Supporter Tag
